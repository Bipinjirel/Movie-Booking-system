    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-purple-700 to-orange-500">
      <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-2xl w-96">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Sign in to continue booking</p>
        </div>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="w-full mt-4 bg-white border border-gray-300 text-gray-700 py-3 rounded-lg font-medium hover:bg-gray-50 transition-all flex items-center justify-center gap-2 shadow-sm"
          >
